...
if ( ! class_exists( 'Designink_Vertical_Mailchimp_Shortcode', false ) ) {

	/**
	 * A static class for dealing with the 'vertical' MailChimp form functionality.
	 */
	class Designink_Vertical_Mailchimp_Shortcode extends Designink_Mailchimp_Shortcode {
		...
		final public static function render( array $attrs ) {
			Designink_Mailchimp_Forms_Plugin::instance()->get_template( 'vertical-mailchimp-form', array( 'attrs' => $attrs ) );
		}

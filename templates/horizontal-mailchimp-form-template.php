...
<div class="designink-mailchimp-shortcode <?php echo $attrs['form_class']; ?> <?php echo $attrs['orientation']; ?>">
	<form
	...
	>
		...
		<div class="primary-input-fields">
			...
			<div class="primary-input-container">
				<?php echo Designink_Mailchimp_Template_Utils::print_submit_button( $attrs, 'horizontal' ); ?>
			</div>
		</div>
